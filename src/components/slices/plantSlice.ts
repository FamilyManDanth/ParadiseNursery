...
const initialState: Plant[] = [
  ...
  {
    img: "src/assets/plants/snakeplant.png",
    name: "Snake Plant",
    cost: 30,
    plant_type: "Potted",
    quantity: 0,
  ...
  {
    img: "src/assets/plants/spiderPlant.png",
    name: "Spider Plant",
    cost: 45,
    plant_type: "Potted",
    quantity: 0,
  ...
  {
    img: "src/assets/plants/PeaceLily.png",
    name: "Peace Lily",
    cost: 80,
    plant_type: "Flower",
    quantity: 0,
  ...
  {
    img: "src/assets/plants/BostonFern.png",
    name: "Boston Fern",
    cost: 45,
    plant_type: "Potted",
    quantity: 0,
  ...
  {
    img: "src/assets/plants/AloeVera.png",
    name: "Aloe Vera",
    cost: 25,
    plant_type: "Potted",
    quantity: 0,
